...
To start a game, type "!$mafia_cmd start [setup]" in the channel. To get a list of setups, use "!$mafia_cmd special". Beginners should stick to straight, mild, balanced, unranked, or average. Once a game has been started, join it by typing "!$mafia_cmd in". You have to do this even if you're the person who started the game. Signups end automatically after 3 minutes. If all interested players have signed up before the timer expires, you can start the game early with 
"!$mafia_cmd go". Your role will be sent to you by $::nick in the form of 'Role (alignment). Roletext. Abilities' To submit a night or day action to the bot, type "/msg $::nick [action] [target]". For example, to inspect Dave, type "/msg $::nick inspect Dave". For more details, type "/msg $::nick help actions". To vote, type "!vote [player]". To clear your vote, type "!unvote". You don't need to unvote before revoting.
For more details, type "/msg $::nick help vote". To see more about gameplay, type !help gameplay. To read the channel rules, type !help rules.
BASICS
